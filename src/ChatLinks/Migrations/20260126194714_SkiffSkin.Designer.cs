...
namespace SL.ChatLinks.Migrations
{
    ...
    [Migration("20260126194714_SkiffSkin")]
    partial class SkiffSkin
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GuildWars2.Hero.Achievements.Achievement", b =>
                {
                    b.Property<int>("Id")
                    ...
                    b.HasDiscriminator<string>("Type").HasValue("achievement");
                });

            modelBuilder.Entity("GuildWars2.Hero.Achievements.Categories.AchievementCategory", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("GuildWars2.Hero.Achievements.Groups.AchievementGroup", b =>
                {
            ...
            modelBuilder.Entity("GuildWars2.Hero.Equipment.MailCarriers.MailCarrier", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("GuildWars2.Hero.Equipment.Miniatures.Miniature", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("GuildWars2.Hero.Equipment.Mounts.MountSkin", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("MountSkins");
                });

            modelBuilder.Entity("GuildWars2.Hero.Equipment.Novelties.Novelty", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("GuildWars2.Hero.Equipment.Outfits.Outfit", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("GuildWars2.Hero.Equipment.Skiffs.SkiffSkin", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("GuildWars2.Pvp.MistChampions.MistChampionSkin", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("SL.ChatLinks.Storage.Models.Hero.Equipment.Mounts.MountSkinUnlock", b =>
                {
                    b.Property<int>("MountSkinId")
                        .HasColumnType("INTEGER");

                    b.Property<int>("ItemId")
                        .HasColumnType("INTEGER");

                    b.HasKey("MountSkinId", "ItemId");

                    b.HasIndex("ItemId");

                    b.ToTable("MountSkinUnlocks");
                });

            modelBuilder.Entity("SL.ChatLinks.Storage.Models.Hero.Equipment.Skiffs.SkiffSkinUnlock", b =>
                {
                    b.Property<int>("SkiffSkinId")
                        .HasColumnType("INTEGER");

                    b.Property<int>("ItemId")
                        .HasColumnType("INTEGER");

                    b.HasKey("SkiffSkinId", "ItemId");

                    b.HasIndex("ItemId");

                    b.ToTable("SkiffSkinUnlocks");
                });

            modelBuilder.Entity("GuildWars2.Hero.Achievements.CollectionAchievement", b =>
                {
                    b.HasBaseType("GuildWars2.Hero.Achievements.Achievement");

                    b.HasDiscriminator().HasValue("collection_achievement");
                });
            ...
            modelBuilder.Entity("GuildWars2.Hero.Crafting.Recipes.BackItemRecipe", b =>
                {
                    b.HasBaseType("GuildWars2.Hero.Crafting.Recipes.Recipe");
            ...
            modelBuilder.Entity("GuildWars2.Hero.Crafting.Recipes.ShortBowRecipe", b =>
                {
                    ...
                    b.HasDiscriminator().HasValue("short_bow");
                });
            ...
            modelBuilder.Entity("GuildWars2.Hero.Equipment.Wardrobe.BackItemSkin", b =>
                {
                    b.HasBaseType("GuildWars2.Hero.Equipment.Wardrobe.EquipmentSkin");
            ...
            modelBuilder.Entity("GuildWars2.Items.BackItem", b =>
                {
                    b.HasBaseType("GuildWars2.Items.Item");
            ...
            modelBuilder.Entity("GuildWars2.Items.MiniatureItem", b =>
                {
                    b.HasBaseType("GuildWars2.Items.Item");
            ...
            modelBuilder.Entity("SL.ChatLinks.Storage.Models.Hero.Equipment.Mounts.MountSkinUnlock", b =>
                {
                    b.HasOne("GuildWars2.Items.Item", null)
                        .WithMany()
                        .HasForeignKey("ItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("GuildWars2.Hero.Equipment.Mounts.MountSkin", null)
                        .WithMany()
                        .HasForeignKey("MountSkinId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("SL.ChatLinks.Storage.Models.Hero.Equipment.Skiffs.SkiffSkinUnlock", b =>
                {
                    ...
                    b.HasOne("GuildWars2.Hero.Equipment.Skiffs.SkiffSkin", null)
                        .WithMany()
                        .HasForeignKey("SkiffSkinId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
