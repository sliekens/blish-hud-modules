...
public sealed class ItemUpgradeBuilder(ItemFlags flags, ItemIcons icons, Customizer customizer)
{
    ...
    private Control? InfusionSlot(InfusionSlot slot, Container parent)
    {
